...
class AddNewBeverageProduct extends StatelessWidget {
  String? catId;

  AddNewBeverageProduct(this.catId);
    ...
    return Scaffold(
      ...
      body: Consumer<AdminProvider>(builder: (context, provider, w) {
        return Container(
          ...
          child: Form(
            key: provider.addBeverageProductKey,
                  ...
                  Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            log(catId!);
                            provider.addNewBeverageProduct(catId!);
                          },
